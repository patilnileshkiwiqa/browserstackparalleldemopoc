...
import com.akami.CommonMethods.CommonMethodsIndexPage;
import com.akami.CommonMethods.CommonMethodsVerification;
import com.akami.Login.LoginIndexPage;
import com.akami.Login.LoginVerification;
import com.akami.reports.ExtentLogger;
import com.akami.reports.ExtentManager;
import com.akami.test.TestIndexPage;
import com.akami.test.TestVerification;
import com.akami.utility.TestData;
...
public class SeleniumInit {
	...
	protected TestVerification testVerification;
	protected TestIndexPage testIndexPage;
	...
	public void setUp(String config_file, String environment, String email, String password, Method method, ITestContext testContext, ITestResult testResult) throws Exception {
		...
		if (TestData.getValueFromConfig("config.properties", "ExecutionPlatform").equalsIgnoreCase("Browserstack")) {
			...
			testIndexPage = new TestIndexPage(driver);
			testVerification = new TestVerification(driver);
